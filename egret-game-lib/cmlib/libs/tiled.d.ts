...
declare module tiled {
    class TMXLayer extends TMXLayerBase {
        static USE_BATCH_RENDER: boolean;
        private _tilewidth;
        private _tileheight;
        ...
        batchContainer: egret.BitmapBatch;
...
declare module tiled {
    var getRes: (url: string, compFunc: Function, thisObject: any, type?: string) => void;
...
declare module tiled {
    class TMXOrthogonalRenderer extends tiled.TMXRenderer {
         ...
         */
        drawTile(renderer: egret.Sprite, tileX: number, tileY: number, tile: tiled.TMXTile): void;
        drawTile2(renderer: egret.BitmapBatch, tileX: number, tileY: number, tile: tiled.TMXTile): void;
        /**
         * 绘制作Tile图层
         * @param layer 图层
         * @param rect  绘制区域
...
declare module tiled {
    class TMXTile extends egret.Sprite {
         ...
         * 获取这个格子的所有属性
         */
        readonly properties: tiled.TMXProperty[];
        /**
         * 获取这个格子名字段为name属性
         */
...
declare module tiled {
    class TMXTileset {
         ...
         * 获取格子纹理信息
         */
        getTileInfo(tile: tiled.TMXTile): {
